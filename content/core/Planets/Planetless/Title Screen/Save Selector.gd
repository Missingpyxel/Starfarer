...
var slot_prefab = preload("res://content/core/Planets/Planetless/Title Screen/Save Slot Stuff/Slot.tscn")
...
func create_slots():
	...
	for save in saves:
		...
		slot.get_node("Mode Indicator").texture = load("res://content/core/Planets/Planetless/Title Screen/Save Slot Stuff/" + slot_info["difficulty"].capitalize() +"Mini.png")
